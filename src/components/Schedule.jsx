    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate__animated animate__fadeIn">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto font-['Montserrat']">Three days packed with exciting events and performances</p>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[#B5EAD7]/10 p-6 rounded-2xl animate__animated animate__fadeInLeft">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="px-4 py-1 rounded-full bg-[#B5EAD7]/20 text-[#B5EAD7] text-sm font-['Montserrat']">Main Stage</span>
                </div>
