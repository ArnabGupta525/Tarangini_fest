            ...
            <div className="space-y-6 mb-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 font-['Montserrat']">info@universityfest.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 font-['Montserrat']">+1 (123) 456-7890</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 font-['Montserrat']">University Campus, City, Country</p>
                </div>
              </div>
            </div>
          </div>
